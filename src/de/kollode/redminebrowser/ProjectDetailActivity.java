...
public class ProjectDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(ProjectDetailFragment.PROJECT_ID, getIntent().getStringExtra(ProjectDetailFragment.PROJECT_ID));
			arguments.putString(ProjectDetailFragment.ACCOUNT_NAME, getIntent().getStringExtra(ProjectDetailFragment.ACCOUNT_NAME));
